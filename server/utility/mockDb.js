...
module.exports = function() {
  ...
  console.log('[mockDb]: Generating Mock Data');

  console.log('\nUsers:');
  mockGenerator.generateUser('admin', 2, 12);
  ...
  mockGenerator.generateUser('student4', 0, 4);
  mockGenerator.generateUser('student5', 0, 5);
  mockGenerator.generateUser('student6', 0, 6);

  console.log('\nRequests:');
  mockGenerator.generateRequest('PHP', 'description', student, 1);
  mockGenerator.generateRequest('Angular', 'description', student2, 0);
  mockGenerator.generateRequest('Fake', '', student3, 0);
};
